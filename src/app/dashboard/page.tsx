...
const cards = [
  { title: 'БКТП', type: 'bktp', href: '/dashboard/bktp', settingsHref: '/dashboard/bktp/settings' },
  { title: 'КТП', type: 'ktp', href: '/dashboard/ktp', settingsHref: '/dashboard/ktp/settings' },
];
          ...
          <Link key={index} href={card.href}>
            <div
              className="w-[376px] h-[160px] bg-[#EDEDED] rounded-xl shadow-md p-4 flex flex-col justify-center
                         transition-transform duration-300 hover:scale-[1.02] cursor-pointer relative
            ...
            >
              ...
              <button
                ...
                className="absolute top-2 right-2 p-1.5 rounded-full transition-all duration-200
                         hover:bg-[#3A55DF] hover:shadow-md group"
                title="Настройки"
              >
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-5 h-5 transition-colors duration-200 group-hover:stroke-white"
                >
                  <path
                    strokeLinecap="round"
