...
export default function ChangePasswordModal({ onClose, onChangePassword }: Props) {
      ...
      <div className="bg-white rounded-2xl w-full max-w-md">
        ...
        <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#8eba1e]/10 rounded-lg">
              <Lock className="w-5 h-5 text-[#8eba1e]" />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#8eba1e] focus:border-[#8eba1e] transition-all"
                value={newPassword}
